...
import {
  LayoutDashboard, Store, PackagePlus, Receipt, Scale,
  Calendar, Settings as SettingsIcon, LogOut, Bell, Search, Menu, X,
} from "lucide-react";
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <aside className="hidden lg:flex w-64 shrink-0 flex-col border-r border-white/10 bg-[rgba(10,15,29,0.9)] backdrop-blur-xl">
          <div className="flex items-center gap-3 px-5 h-16 border-b border-white/10">
            <img src="/auro-logo.png" alt="Auro" className="h-9 w-9 rounded-lg object-contain" />
            <div>
          ...
          <div className="p-4 border-t border-white/10">
            <button
              ...
              onClick={logout}
              className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm text-slate-400 hover:text-red-300 hover:bg-red-500/10 transition-colors"
            >
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b border-white/10 bg-[rgba(15,23,42,0.75)] backdrop-blur-xl px-4 md:px-6">
            ...
            <div className="ml-auto flex items-center gap-3">
              <button
                data-testid="reminder-alert-button"
